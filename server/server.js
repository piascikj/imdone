 ...
 */
  // ARCHIVE:150 Upgrade express - [ExpressJS 4.0: New Features and Upgrading from 3.0 ♥ Scotch](http://scotch.io/bar-talk/expressjs-4-0-new-features-and-upgrading-from-3-0) id:5106
  ...
  // ARCHIVE:200 use imdone-core id:5107
  ...
  // ARCHIVE:210 use imdone-core id:5108
  ...
  // ARCHIVE:220 use imdone-core id:5156
  ...
  // ARCHIVE:230 use imdone-core id:5136
  ...
  // ARCHIVE:240 use imdone-core id:5109
  ...
  // ARCHIVE:250 use imdone-core id:5110
  ...
  // ARCHIVE:260 use imdone-core id:5111
  ...
  // ARCHIVE:920 Have this use splat for project name like getFiles id:5157
  // ARCHIVE:620 Move getSource to imdone.js id:5137
  // ARCHIVE:270 use imdone-core id:5112
  ...
  // ARCHIVE:940 Have this use splat for project name like getFiles id:5113
  // ARCHIVE:280 use imdone-core id:5114
  ...
  // ARCHIVE:870 Move removeSource to imdone.js and add hook     id:5158
  // ARCHIVE:170 use imdone-core for removeSource id:5138
  ...
  // ARCHIVE:290 use imdone-core id:5115
  ...
  // PLANNING:170 Use imdone-core for md, local and remote id:5117
  function md(req,res) {
    var project = projectNameFromRequest(req);
  ...
  // ARCHIVE:300 use imdone-core for search id:5116
  ...
  server.start = function(imdone, callback) {
    ...
    //ARCHIVE:810 migrate to express 3.x <https://github.com/visionmedia/express/wiki/Migrating-from-2.x-to-3.x> id:5159
    ...
    /*
      ...
      /api/files
    */
    // ARCHIVE:960 Make sure we're restful id:5139
    ...
    io.sockets.on('connection', function(socket) {
      ...
      // ARCHIVE:310 Remove listeners on disconnect id:5118
    ...
    //ARCHIVE:410 Move open board to command line option **open** id:5119
  };
