 ...
 */
//ARCHIVE:450 Implement hide functionality to hide a list from board id:5011
// Nodejs libs.
var fs               = require('fs');
...
imdone.start = function(dirs, _open, noServer, cb) {
  ...
  function init() {
    // DONE:40 Should be able to start without server id:4992
...
// PLANNING:80 Use axon-rpc for cli service and move to it's own module id:4985
...
// PLANNING:40 Set a default project in config to be opened when iMDone starts id:4981
