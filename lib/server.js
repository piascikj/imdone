 ...
 */
	...
	function getSource(req,res) {
		...
		//[Make sure this source file is in one of the projects paths](#archive:0)
		...
		var styles =  nsh.getStyles()
		  ...
		  , style  =  styles[index]
		  ;
		//[Use the RDark style <http://alexgorbatchev.com/SyntaxHighlighter/manual/themes/rdark.html>](#archive:20)
	...
	server.start = function(imdone, callback) {
		...
		//[Move open board to command line option **open**](#todo:30)
	};
