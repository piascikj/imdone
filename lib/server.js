 ...
 */
	...
	//[Have this use splat for project name like getFiles](#archive:140)
	function getSource(req, res) {
		...
		if (project.path && /^\.\./.test(path) == false && /\/$/.test(path) == false) {
			...
			//[Use the RDark style <http://alexgorbatchev.com/SyntaxHighlighter/manual/themes/rdark.html>](#archive:190)
			//[Maybe use **Mu - <https://github.com/raycmorgan/Mu>** for templating.](#archive:200)
	...
	//[Have this use splat for project name like getFiles](#archive:110)
	...
	server.start = function(imdone, callback) {
		...
		//[migrate to express 3.x <https://github.com/visionmedia/express/wiki/Migrating-from-2.x-to-3.x>](#archive:60)
		...
		*/
		...
		//[Move open board to command line option **open**](#archive:160)
	};
