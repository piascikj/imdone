 ...
 */
	...
	function getSource(req,res) {
		...
		//[Make sure this source file is in one of the projects paths](#archive:60)

		//[Use the RDark style <http://alexgorbatchev.com/SyntaxHighlighter/manual/themes/rdark.html>](#archive:30)
		//[Maybe use **Mu - <https://github.com/raycmorgan/Mu>** for templating.](#archive:40)
	...
	server.start = function(imdone, callback) {
		...
		//[Move open board to command line option **open**](#doing:10)
	};
