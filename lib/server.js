 ...
 */
	...
	function getSource(req,res) {
		...
		//[Make sure this source file is in one of the projects paths](#doing:20)
		...
		var styles =  nsh.getStyles()
		  ...
		  , style  =  styles[index]
		  ;
		//[Use the RDark style <http://alexgorbatchev.com/SyntaxHighlighter/manual/themes/rdark.html>](#doing:0)
		//[Maybe use **Mu - <https://github.com/raycmorgan/Mu>** for templating.](#doing:10)
		fs.readFile(filePath, 'utf-8', function(err,data) {
			...
			var language        =  nsh.getLanguage('js')
			  , highlightedCode =  nsh.highlight(data, language);
			res.send({code:highlightedCode, style:style});
		});
	}
