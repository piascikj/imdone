 ...
 */
	...
	//[Have this use splat for project name like getFiles](#archive:120)
	function getSource(req, res) {
		...
		if (project.path && /^\.\./.test(path) == false && /\/$/.test(path) == false) {
			...
			//[Make sure this source file is in one of the projects paths](#archive:210)

			//[Use the RDark style <http://alexgorbatchev.com/SyntaxHighlighter/manual/themes/rdark.html>](#archive:170)
			//[Maybe use **Mu - <https://github.com/raycmorgan/Mu>** for templating.](#archive:180)
	...
	//[Have this use splat for project name like getFiles](#archive:90)
	...
	server.start = function(imdone, callback) {
		...
		//[migrate to express 3.x <https://github.com/visionmedia/express/wiki/Migrating-from-2.x-to-3.x>](#archive:40)
		...
		//[API should be more RESTful](#planning:60)
		/*
			/api/tasks
			/api/lists
			/api/projects
		...
		*/
		...
		//[Move open board to command line option **open**](#archive:140)
	};
