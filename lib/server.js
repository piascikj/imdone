 ...
 */
	...
	//[Have this use splat for project name like getFiles](#archive:170)
    //[Move getSource to imdone.js](#doing:10)
    function getSource(req, res) {
		...
		if (project.path && /^\.\./.test(path) == false && /\/$/.test(path) == false) {
			...
			//[Make sure this source file is in one of the projects paths](#archive:260)

			//[Use the RDark style <http://alexgorbatchev.com/SyntaxHighlighter/manual/themes/rdark.html>](#archive:220)
			//[Maybe use **Mu - <https://github.com/raycmorgan/Mu>** for templating.](#archive:230)
    ...
    //[Move saveSource to imdone.js](#doing:20)    
	...
	server.start = function(imdone, callback) {
		...
		//[API should be more RESTful](#planning:120)
		/*
			/api/tasks
			/api/lists
			/api/projects
		...
		*/
		...
		//[Move open board to command line option **open**](#archive:190)
	};
