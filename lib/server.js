 ...
 */
  ...
  //[Have this use splat for project name like getFiles](#archive:180)
    //[Move getSource to imdone.js](#doing:80)
  ...
  //[Have this use splat for project name like getFiles](#archive:160)
    //[Move saveSource to imdone.js](#doing:100)    
  ...
  function doSearch(req,res) {
    ...
    var s = search.newSearch({path:project.path, limit:limit, query:query});
    s.execute();
    res.send(s);
  ...
  server.start = function(imdone, callback) {
    ...
    //[API should be more RESTful](#planning:160)
    /*
      /api/tasks
      /api/lists
      /api/projects
      ...
      /api/files
    */
    // [Make sure we're restful](#doing:20)
