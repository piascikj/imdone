 ...
 */
//[Implement base repository functionality with [declare.js](https://npmjs.org/package/declare.js)](#doing:10) 
var fs = require('fs');
...
Repository.prototype = {
	...
	filesToProcess: function(path, files, showDirs) {
		...
		_.each(files, function(file, i) {
			...
			if (self.config.include.test(relPathFile) == true 
				&& self.config.exclude.test(relPathFile) == false 
