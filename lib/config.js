 ...
 */
// [add include option for processing tasks - introduced in 0.1.3](#archive:30)
// [if running localy it should give the option to open the file in the browser even if github is set](#todo:20)
module.exports = {
	include:/^.*$/,
