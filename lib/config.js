...
// [if running localy it should give the option to open the file in the browser even if github is set](#archive:90)
module.exports = {
	include:/^.*$/,
	exclude:/^(node_modules|imdone|target)\/|\.(git|svn)|\~$|\.(jpg|png|gif|swp)$/,
	//[Remove github option - now editing in UI with Ace](#planning:0)
