 ...
 */
// [add include option for processing tasks - introduced in 0.1.3](#archive:90)
...
module.exports = {
	...
	//[add a lists property for lists that are always displayed, even if there are no tasks in them](#done:30)
};