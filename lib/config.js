 ...
 */
// [add include option for processing tasks - introduced in 0.1.3](#done:30)
// [if running localy it should give the option to open the file in the browser even if github is set](#todo:10)
module.exports = {
	include:/^.*$/,
