 ...
 */
//[Implement hide functionality to hide a list from board](#archive:210)
// Nodejs libs.
var fs = require('fs');
...
//[Fix task regex so that tasks that appear in markdown as code aren't displayed - 0.1.6](#archive:300)
...
//[When moving task to top of list, it goes to second place.  Need to fix this](#archive:170)
...
imdone.Project.prototype.processFiles = function(files, callback) {
	try {
		...
		_.each(files, function(file, i) {
			...
			//[Make this an async file read](#archive:260)
			var data = fs.readFile(fullPathFile, 'utf8', function (err, data) {
				...
				data.replace(imdone.taskregx, function(md, text, list, order, pos) {
					if (!self.isCode(data, pos)) {
						...
						//[Use line number when loading page in github - 0.1.4](#archive:320)
...
imdone.Project.prototype.watchFiles = function(path) {
	...
	watchr.watch({
    	...
    	//[Use ignoreCustomPatterns](#archive:250)
...
/*
	...
	- [Modify process.env to contain the port info for cliService](#archive:180)
