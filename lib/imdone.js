 ...
 */
//[Implement hide functionality to hide a list from board](#doing:10)
// Nodejs libs.
var fs = require('fs');
...
imdone.Project = function(path) {
	...
	this.initConfig();
	this.loadListData();
	this.cwd = path; //[Stop using process.cwd, use the path instead](#archive:10)
...
imdone.Project.prototype.watchFiles = function(path) {
	...
	watchr.watch({
    	...
    	//[Use ignoreCustomPatterns](#doing:0)
    	listeners: {
	        /*
