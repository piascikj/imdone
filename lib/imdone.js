...
imdone.update = function(files) {
	_.each(files, function(file) {
		if (!imdone.isPaused(file)) {
			//[Store last updated time, and check to see if we should process](#doing:10)
...
imdone.cli = function() {
	...
	//[We want to accept a root directory as an argument](#to-do:30)
	imdone.start(".");
