define([
  ...
  imdone.md = function() {
    ...
    var externalLinks = /(<a.*?href="http.*?)>/ig;
  ...
  //[User should be prompted when closing a file.  If it's been modified and not saved, show modal to ask for save](#planning:10)
  ...
  //[Implement delete file functionality](#planning:30)
  ...
  imdone.init = function() {
      ...
      //editor.setReadOnly(true);  // [Make files editable](#archive:70)
      ...
      keyBinding.addKeyboardHandler(new HashHandler([{
          ...
          descr: "close file",
          exec: function() {
            if (!imdone.previewMode && imdone.isMD()) {
              imdone.showPreview();
            } else {
