define([
  ...
  imdone.md = function(md) {
    ...
    //[Let mailto links open email client](#done:40)
  ...
  //[Implement delete file functionality](#done:100)
  ...
  var AppRouter = Backbone.Router.extend({
      routes: {
          ...
          "filter/*filter" : "filterRoute", //[Filter route so links can change filter](#done:70)
