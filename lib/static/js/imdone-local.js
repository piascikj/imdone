define([
  ...
  imdone.md = function() {
    ...
    //[For markdown files, find tasks links and give them a badge](#done:10)
  ...
  //[User should be prompted when closing a file.  If it's been modified and not saved, show modal to ask for save](#doing:10)
