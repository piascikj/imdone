define([
  ...
  imdone.md = function() {
    ...
    //[For internal inks, take them to the page](#done:0)
  ...
  //[Implement delete file functionality](#planning:20)
  ...
  imdone.init = function() {
      ...
      //[Apply filter when kanban is reloaded](#done:30)
  ...
  var AppRouter = Backbone.Router.extend({
      routes: {
          //[Set up router for projects and files](#done:20)
