define([
  ...
  imdone.init = function() {
      ...
      //editor.setReadOnly(true);  // [Make files editable](#archive:10)
      ...
      imdone.getSource = function(params) {
        //[We have to convert the source api url URL first](#archive:130)
        ...
        $.get(url, function(data){
          ...
          //[Update file-path on edit button](#done:0)
      ...
      $('.source-link').live("click", function(e) {
        ...
        //[Show the current task as notification with <http://pinesframework.org/pnotify/>](#archive:70)
        $.pnotify({
          title: list,
          text: taskHtml,
          nonblock: true,
      ...
      $('#file-open').live('click',function() {
        //[Create a new file based on path and project with call to /api/source](#archive:50)
      ...
      //[Apply filter when kanban is reloaded](#doing:0)
