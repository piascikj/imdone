define([
  ...
  imdone.search = function(params) {
    ...
    if (project) {
      ...
      search.fetch({success: function(model, response)  {
          // [Put search in a view.  [What is a view? - Backbone.js Tutorials](http://backbonetutorials.com/what-is-a-view/)](#planning:130)
  ...
  imdone.init = function() {
      ...
      //[Use Vim keyboard bindings](#planning:230)
