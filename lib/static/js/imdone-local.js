define([
  ...
  imdone.md = function(md) {
    ...
    //[Let mailto links open email client](#done:10)
  ...
  imdone.search = function(params) {
    ...
    if (project) {
      ...
      search.fetch({success: function(model, response)  {
          // [Put search in a view.  [What is a view? - Backbone.js Tutorials](http://backbonetutorials.com/what-is-a-view/)](#doing:0)
  ...
  //[Implement delete file functionality](#done:70)
  ...
  var AppRouter = Backbone.Router.extend({
      routes: {
          ...
          "filter/*filter" : "filterRoute", //[Filter route so links can change filter](#done:40)
