define([
  ...
  'jqueryui',
  'bootstrap'
], function(_, $, Backbone, Handlebars, JSON, io, marked, ace) {
  ace = require('ace/ace');
  console.log(ace);
  var imdone = {
    data:{},
  ...
  imdone.md = function() {
    ...
    //[Find task links and give them a badge](#doing:10)
    return html;
  }
  ...
  imdone.init = function() {
      ...
      function showEditor() {
        ...
        imdone.editor.focus();
        imdone.editor.gotoLine(data.line);
        imdone.preview.hide();
      ...
      imdone.editor.keyBinding.addKeyboardHandler(new HashHandler([{
          bindKey: "Ctrl+s",
          descr: "Save File",
          exec: saveFile
      }]));
