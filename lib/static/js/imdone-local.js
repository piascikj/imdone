define([
  ...
  imdone.md = function() {
    ...
    //[For markdown files, find tasks links and give them a badge](#archive:0)
    //[For internal inks, take them to the page](#archive:40)
  ...
  //[Implement delete file functionality](#planning:90)
  ...
  imdone.getSource = function(params) {
    //[We have to convert the source api url URL first](#archive:180)
    ...
    $.get(url, function(data){
      ...
      //[Update file-path on edit button](#archive:50)
  ...
  imdone.init = function() {
      ...
      //[Use Vim keyboard bindings](#planning:0)
      ...
      //[Apply filter when kanban is reloaded](#archive:10)
      ...
      $(".list-hide, .list-show").live('click', function(e) {
        imdone.app.navigate("lists/" + $(this).attr("data-list"), {trigger:true});
        e.stopPropagation();
      });
  ...
  var AppRouter = Backbone.Router.extend({
      routes: {
          //[Set up router for projects and files](#archive:20)
          "project*project": "projectRoute",
          "file?*querystring": "fileRoute",
          "lists/:list": "listRoute",
      ...
      listRoute: function(list) {
        console.log("list route:" + list);
        var el = $("#" + list);
        if (el.length > 0) {
