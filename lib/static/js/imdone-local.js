define([
  ...
  imdone.md = function() {
    ...
    //[For markdown files, find tasks links and give them a badge](#doing:40)
    return html;
  }
  ...
  imdone.init = function() {
      ...
      //editor.setReadOnly(true);  // [Make files editable](#done:110)
      ...
      function showEditor() {
        ...
        $.pnotify({
          ...
          history: false,
          type: 'success',
          stack: {"dir1": "down", "dir2": "left", "push": "bottom", "spacing1": 44, "spacing2": 44}
        });
        */
      }
      ...
      $('#file-open').live('click',function() {
        //[Create a new file based on path and project with call to /api/source](#done:10)
