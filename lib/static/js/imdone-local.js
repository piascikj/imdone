define([
  ...
  imdone.md = function() {
    ...
    //[For markdown files, find tasks links and give them a badge](#doing:0)
    return html;
  }
  ...
  imdone.init = function() {
      ...
      //editor.setReadOnly(true);  // [Make files editable](#done:100)
      ...
      imdone.addHistory = function() {
        ...
        if (projectHist.length > 10) projectHist.pop();
      ...
      imdone.getSource = function(params) {
        //[We have to convert the source api url URL first](#done:0)
      ...
      $('.source-link').live("click", function(e) {
        ...
        //[Show the current task as notification with <http://pinesframework.org/pnotify/>](#done:40)
        $.pnotify({
          title: list,
          text: taskHtml,
          nonblock: true,
      ...
      $('#file-open').live('click',function() {
        //[Create a new file based on path and project with call to /api/source](#done:60)
