...
### Misc
- [parse github wiki links to point at files](#done:50)
- [Move task causes multiple updates to board](#done:60)
- [Filter should stick with project, but clear when project changes](#done:0)
- [Fix include and excludes](#done:40)
...
- [User should be able to jump to task by clicking it in preview and if list is hidden it should show and task should be highlighted](#done:110)
- [Use prism for syntax highlighting [Prism](http://prismjs.com/)](#done:150)
...
- [Start using travis for CI <https://travis-ci.org/>](#done:10)
...
- [If links to files exist in tasks, open the file on click](#done:220)
...
- [User should be able to print board as lists of tasks](#done:190)
- [If a README.md exists, show notification with link](#archive:20)
- [Create docs site <http://blog.jetstrap.com/2013/03/building-a-docs-site-with-jekyll-github-pages/>](#done:140)
...
- [Make html and xml files printable](#done:200)
...
- [User should be able to use TOC in preview mode for md files](#done:130)
