...
- [If links to files exist in tasks, open the file on click](#done:180)
...
- [Add search for files and tasks <https://github.com/visionmedia/search> or <https://github.com/visionmedia/reds>](#done:120)
...
- [User should be able to print board as lists of tasks](#done:140)
- [If a README.md exists, show notification with link](#archive:20)
- [Create docs site <http://blog.jetstrap.com/2013/03/building-a-docs-site-with-jekyll-github-pages/>](#done:70)
...
- [Make html and xml files printable](#done:150)
...
- [Move search to a dialog that's always available with ctrl+shift+f #bug](#done:100)
...
- [User should be able to use TOC in preview mode for md files](#done:60)
