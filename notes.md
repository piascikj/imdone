...
### Misc
- [Fix show list on task-link](#done:0) 
- [User should be able to execute a javscript callback when a files are modified in the editor or by moving a task](#doing:50)
- [User should be able to jump back to the task in the board if the task is clicked in the file view task notification](#doing:60)
- [User should be able to rename a file](#doing:70)
- [Switch from flattr to gittip](#doing:80)
- [User should get a modal confirmation if closing a file that has been edited #feature](#done:20)
- [User should be able to add #hashtags to a #task and filter by them #feature](#doing:90)
    - They could be after the list name like #doing#feature and apear as a pill or badge on the front end
- [User should be able to jump to task by clicking it in preview and if list is hidden it should show and task should be highlighted](#done:10)
- [Use prism for syntax highlighting [Prism](http://prismjs.com/)](#done:50)
...
- [If links to files exist in tasks, open the file on click](#done:150)
...
- [Add search for files and tasks <https://github.com/visionmedia/search> or <https://github.com/visionmedia/reds>](#done:90)
...
- [User should be able to print board as lists of tasks](#done:110)
- [If a README.md exists, show notification with link](#archive:20)
- [Create docs site <http://blog.jetstrap.com/2013/03/building-a-docs-site-with-jekyll-github-pages/>](#done:40)
...
- [Make html and xml files printable](#done:120)
...
- [Move search to a dialog that's always available with ctrl+shift+f #bug](#done:70)
...
- [User should be able to use TOC in preview mode for md files](#done:30)
