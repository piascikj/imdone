...
### Misc
- [parse github wiki links to point at files](#done:40)
- [Move task causes multiple updates to board](#done:50)
- [Filter should stick with project, but clear when project changes](#doing:10)
- [Fix include and excludes](#done:20)
- [Fix show list on task-link](#done:90) 
- [User should be able to execute a javscript callback when a files are modified in the editor or by moving a task](#done:10)
- [User should be able to jump back to the task in the board if the task is clicked in the file view task notification](#done:60)
- [User should be able to rename a file](#doing:30)
- [Switch from flattr to gittip](#doing:50)
- [User should get a modal confirmation if closing a file that has been edited #feature](#done:110)
- [User should be able to add #hashtags to a #task and filter by them #feature](#doing:40)
    - They could be after the list name like #doing#feature and apear as a pill or badge on the front end
- [User should be able to jump to task by clicking it in preview and if list is hidden it should show and task should be highlighted](#done:100)
- [Use prism for syntax highlighting [Prism](http://prismjs.com/)](#done:140)
...
- [If links to files exist in tasks, open the file on click](#done:240)
...
- [Add search for files and tasks <https://github.com/visionmedia/search> or <https://github.com/visionmedia/reds>](#done:180)
...
- [Create docs site <http://blog.jetstrap.com/2013/03/building-a-docs-site-with-jekyll-github-pages/>](#done:130)
...
- [Move search to a dialog that's always available with ctrl+shift+f #bug](#done:160)
...
- [User should be able to use TOC in preview mode for md files](#done:120)
