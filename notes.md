...
- [User should be able to create .md files and have them open in the editor](#doing:50)
- [Modularize code [Organizing your application using Modules (require.js) - Backbone.js Tutorials](http://backbonetutorials.com/organizing-backbone-using-modules/)](#doing:40)
...
- [Create docs site <http://blog.jetstrap.com/2013/03/building-a-docs-site-with-jekyll-github-pages/>](#doing:90)
...
- [Add link to Asciiflow <http://www.asciiflow.com/#Draw>](#doing:130)
