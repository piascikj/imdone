...
- [use [doco languages.js](https://github.com/jashkenas/docco/blob/master/resources/languages.json) to [detect TODO and FIXME](lib/imdone.js) style comments and convert but keep the TODO or FIXME or whatever in the front.](#doing:30)
...
- [Add search for files and tasks <https://github.com/visionmedia/search>](#planning:100)
- [Block entry and ask the user to load changes if a file changes while editing](#planning:60)
- [When a user clicks task link in MD, current task should change](#planning:80)
- [On opening of file, set the project at the global level](#done:20)
- [User should be able to print board as lists of tasks](#planning:50)
- [If a README.md exists, show notification with link](#done:0)
- [Create docs site <http://blog.jetstrap.com/2013/03/building-a-docs-site-with-jekyll-github-pages/>](#planning:40)
