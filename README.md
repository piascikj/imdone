...
- Create tasks in any text file using markdown link syntax like
  - `[Finish the latest blog post id:3732](#doing:0)`
  - or with a hashtag `#doing:0 Finish the latest blog post` id:3731
...
```
[Use imdone to manage tasks in my project id:3733](#done:0)
```
- Or like this
```
When your in the middle of a scentence #todo:0 write a task like this. id:3734
```
...
### Keep tasks in code  
```javascript
//[this is a todo task in javascript code id:3748](#todo:0)
```

###Embed a filter link in a task
```
[Filter by [src/main/java](#filter/src/main/java) id:3736](#filters:0)
```  
