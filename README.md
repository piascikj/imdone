...
- Create tasks in any text file using markdown link syntax like
  - `[Finish the latest blog post id:3304](#doing:0)`
  - or with a hashtag `#doing:0 Finish the latest blog post` id:3302
...
```
[Use imdone to manage tasks in my project id:3305](#done:0)
```
- Or like this
```
When your in the middle of a scentence #todo:0 write a task like this. id:3303
```
...
### Keep tasks in code  
```javascript
//[this is a todo task in javascript code id:3307](#todo:0)
```

###Embed a filter link in a task
```
[Filter by [src/main/java](#filter/src/main/java) id:3306](#filters:0)
```  
